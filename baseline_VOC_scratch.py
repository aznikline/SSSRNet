...
parser.add_argument("--clip", type=float, default=3000, help="Clipping Gradients. Default=0.1")
...
def main():
    print("SRNet training from scratch on VOC 160*160 patches.")
...
def save_checkpoint(model, epoch):
    model_out_path = "model/" + "SRResNet_VOC160_scratch{}.pth".format(epoch)
