...
def main():
    print("SSSRNet7 finetune on VOC 160*160 patches.")
...
def train(training_data_loader, optimizer, model, model_pretrained, criterion, epoch, gpuid):
    ...
    for iteration, batch in enumerate(training_data_loader, 1):
        ...
        for i in range(20):
            ...
            classwise_loss = criterion(classwise_output, classwise_target) / opt.batchSize
...
def save_checkpoint(model, epoch):
    model_out_path = "model/" + "SSSRNet7_160_epoch_{}.pth".format(epoch)
