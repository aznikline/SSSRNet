...
from SSSRNet5_enhanced import Net
...
def main():
    print("SSSRNet5_enhanced1 finetune training on VOC 160*160 patches.")
...
def save_checkpoint(model, epoch):
    model_out_path = "model/" + "SSSRNet5_enhanced160_epoch_{}.pth".format(epoch)
