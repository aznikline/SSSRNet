...
from SSSRNet4 import Net, mid_layer
...
parser.add_argument("--model", default="model/SSSRNet3_deeplab_epoch_50.pth", type=str, help="model path")
...
SR_dir = join(root_dir, 'VOC_SSSR3')
