...
from baseline_SSSR3 import Net
...
parser.add_argument("--clip", type=float, default=1000, help="Clipping Gradients. Default=0.1")
...
def main():
    print("baseline_SSSR3 training from finetune on VOC 160*160 patches.")
...
def save_checkpoint(model, epoch):
    model_out_path = "model/" + "baseline_SSSR3_lr_finetune{}.pth".format(epoch)
