...
def main():
    print("SSSRNet3 training finetuning on VOC 160*160 patches.")
...
def save_checkpoint(model, epoch):
    model_out_path = "model/" + "SSSRNet3_finetune_160_epoch_{}.pth".format(epoch)
