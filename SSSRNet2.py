...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv_input = nn.Conv2d(in_channels=23, out_channels=64, kernel_size=9, stride=1, padding=4, bias=True)
        self.relu = nn.LeakyReLU(0.2, inplace=True)
    ...
    def forward(self, x, seg):
        ...
        out = self.conv_output(out) + self.up4x(x)
        return out
